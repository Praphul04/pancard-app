...
const MinorPanCardApplyForm = ({ showTitle }) => {

    const faqs = [
        {
          question: "What is Minor PAN Card?",
          answer: (
            <div>
              Pan Card for Individuals below 18 years i.e. Young person is called Minor PAN Card. Minor PAN Card do not have Applicant's Photo on it. It has parent's/guardian's signature on it.
              It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. Most important, it also has Hologram which makes it genuine ID proof for its holder. This is why Minor PAN Card is asked to by banks or other financial institutions as proof of Identity of Minor - below 18 year individual.
            </div>
          )
        },
        {
          question: "How to apply for Minor PAN Card?",
          answer: (
            <div>
              You can apply for Minor PAN Card online by filling up the above Minor PAN Card Application Form and complete all steps with required documents.
            </div>
          )
        },
        {
          question: "How can I get PAN card for Minor?",
          answer: (
            <div>
              You can apply for Minor PAN online by filling up the above Minor PAN Card Application Form and complete all steps with required documents.
            </div>
          )
        },
        {
        ...
        {
          question: "Can a Minor under 18 years apply for PAN card?",
          answer: (
            <div>
              Yes definitely. Minor's parent or guardian can apply for PAN card of minor.
            </div>
          )
        },
        {
          question: "Is minor PAN card valid?",
          answer: (
            <div>
              Yes, minor PAN card is valid.
            </div>
          )
        },
        {
          question: "What Documents are required for Minor PAN Card Application?",
          answer: (
            <div>
              <div><strong>Identity Proof of Minor / Infant / Kid:</strong></div>
              <ol>
                <li>Aadhaar card</li>
              </ol>
              <div><strong>Date Of Birth Proof of Minor (Any one):</strong></div>
              <ol>
                <li>Aadhaar Card</li>
        ...
        {
          question: "Who has to sign the PAN Card application for Minor?",
          answer: (
            <div>
              Any one of Minor's Parent or Guardian needs to sign the PAN Card Form. If he/she is unable to do sign then left thumb impression is required on form.
            </div>
          )
        },
        {
          question: "How Minor PAN Card will be delivered?",
          answer: (
            <div>
              Minor PAN Card will be delivered to Parent or Guardian's Address by Courier mentioned in PAN Form while applying PAN card for minor online. Address proof having the same address needs to be submitted along with the application.
            </div>
          )
        },
        {
          question: "How can I track Minor PAN Card Status after application?",
          answer: (
            <div>
              After applying PAN Card for Minor, you can track PAN card status on our portal at below link: <br />
...
<div className="column col-12">
             ...
             New PAN Card Application for<mark  style={{fontSize:"20px"}}>Minor (Below 18 Years) / Child / Infant</mark>
              </h1>
              ...
              <div className="hero bg-gray">
                <div className="hero-body">
                  ...
                  <div className="form-group form-group-select-poi-proof">
                    ...
                    >
                      Minor Applicant's Identity Proof
                    </label>
                    <select
                      className="form-select"
      ...
      <h2 className="text-center">FAQs: Minor PAN Card Apply Online - Under 18 years</h2>
      {faqs.map((faq, index) => (
...
export default MinorPanCardApplyForm;
