...
const CoOperativeSocietyForm = () => {
  ...
  const faqs = [
    {
      question: "How to apply PAN card for Co-Operative Society?",
      answer: "You can apply PAN Card for Co-Operative Society online by filling up the above Co-Operative Society PAN Card Application Form and completing all steps with the required documents."
    },
    {
      question: "What Documents are required for Co-Operative Society PAN Card Application?",
      answer: (
        <div>
          <div><strong>Co-Operative Society Identity Proof (Any one):</strong></div>
          <ol>
          ...
          <div><strong>Co-Operative Society Address Proof (Any one):</strong></div>
          <ol>
            <li>Copy of Agreement.</li>
            <li>Registration Certificate issued by Charity Commissioner.</li>
            <li>Registration Certificate issued by Cooperative Society Registrar.</li>
    ...
    {
      question: "Who has to sign the PAN application for Co-Operative Society?",
      answer: "Any one Authorized Signatory or Managing Person like Chairman or Secretary or Treasurer can sign the PAN Card Form."
    },
    {
      question: "How Co-Operative Society PAN Card will be delivered?",
      answer: "Co-Operative Society PAN Card will be delivered to Co-Operative Society's Address by Courier mentioned in PAN Form while applying for PAN Card for Co-Operative Society online. Address proof having the same address needs to be submitted along with the application."
    },
    {
      question: "How can I track Co-Operative Society PAN Card Status after application?",
      answer: (
        <div>
          After applying PAN Card for Co-Operative Society, you can track PAN card status on our portal at the below link: <br />
      ...
      <div className="columns">
        <div className="column col-12">
          <h1 className="pan-form-heading">New PAN Application for
            <small className="label">Co-Operative Society</small>
          </h1>
        </div>
        <div className="column col-12">
          <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                <div className="form-group">
                  <label className="form-label" htmlFor="fullName">Co-Operative Society Full Name</label>
                  <input
                ...
                <div className="form-group form-group-select-poi-proof">
                  <label className="form-label" htmlFor="identityProof">Co-Operative Society Identity Proof</label>
                  <select
                    className="form-select"
                    id="identityProof"
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                ...
                <div className="form-group form-group-address-proof">
                  <label className="form-label" htmlFor="addressProof">Co-Operative Society Address Proof</label>
                  <select
                    className="form-select"
                    id="addressProof"
...
<h2 className="text-center">FAQs: Apply PAN Card for Co-Operative Society</h2>
{faqs.map((faq, index) => (
...
export default CoOperativeSocietyForm;
