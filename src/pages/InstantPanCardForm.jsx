...
const InstantPanCardForm = () => {
  ...
  const faqs = [
    {
      question: "What is Instant PAN to Physical PAN Card?",
      answer: "PAN holder details is printed on Physical Card by Income Tax Department. It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. It also has Hologram which makes it genuine ID proof for its holder. This is why Physical PAN Card from Instant PAN is asked to by banks or other financial institutions as proof of Identity."
    },
    {
      question: "Why Instant PAN to Physical PAN Card is required?",
      answer: "Some Banks or Financial Institutions ask to present Physical PAN Card as PAN proof even though we have Instant PAN copy while opening bank account or any work related to loans. At such moments it is necessary to convert Instant PAN to Physical PAN Card."
    },
    {
      question: "How to get Physical PAN Card from Instant PAN?",
      answer: "You can get Physical PAN Card from Instant PAN by filling up the above Instant PAN to Physical Card Application Form and complete all steps with required documents."
    },
    {
      question: "How to convert Instant PAN to Physical PAN Card?",
      answer: "To convert Instant PAN to Physical PAN Card, you need to Apply for 'Instant PAN to Physical PAN Card' using above Application Form and get Card delivered at home as per address mentioned in the form."
    },
    {
      question: "What Documents are required to convert Instant PAN to Physical PAN Card?",
      answer: (
        <div>
    ...
    {
      question: "How Physical PAN Card from Instant PAN will be delivered?",
      answer: "Physical Card from Instant PAN will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying Instant PAN to Physical Card. Address proof having same address needs to be submitted along with application."
    },
    {
      question: "How can I track Instant PAN to Physical PAN Card Status after application?",
      answer: (
        <div>
          After applying Physical PAN Card from Instant PAN, you can track PAN card status on our portal at below link: <br />
  ...
  return (
    ...
    <div className="container">
      <div className="">
        <h1 className="hero-body pan-form-heading">Instant PAN to Physical PAN Card Application</h1>
      </div>
   ...
   <div className="form-correction-group">
    ...
    <div className="container">
      <h2 className="text-center">FAQs: Instant PAN to Physical PAN Card Application</h2>
      {faqs.map((faq, index) => (
...
export default InstantPanCardForm;
