...
const EpanToPhysicalPanCArdForm = () => {
  ...
  const faqs = [
    {
      question: "What is ePAN to Physical PAN Card?",
      answer: "PAN holder details is printed on Physical Card by Income Tax Department. It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. It also has Hologram which makes it genuine ID proof for its holder. This is why Physical PAN Card from ePAN is asked to by banks or other financial institutions as proof of Identity."
    },
    {
      question: "Why ePAN to Physical PAN Card is required?",
      answer: "Some Banks or Financial Institutions ask to present Physical PAN Card as PAN proof even though we have ePAN copy while opening bank account or any work related to loans. At such moments it is necessary to convert ePAN to Physical PAN Card."
    },
    {
      question: "How to get Physical PAN Card from ePAN?",
      answer: "You can get Physical PAN Card from ePAN by filling up the above ePAN to Physical Card Application Form and complete all steps with required documents."
    },
    {
      question: "How to convert ePAN to Physical PAN Card?",
      answer: "To convert ePAN to Physical PAN Card, you need to Apply for 'ePAN to Physical PAN Card' using above Application Form and get Card delivered at home as per address mentioned in the form."
    },
    {
      question: "Is this ePAN To Physical PAN Card with Signature and Photo?",
      answer: "Yes, Physical card will have applicant's Signature and Photo printed on it."
    },
    {
      question: "What Documents are required to convert ePAN to Physical PAN Card?",
      answer: (
        <div>
    ...
    {
      question: "How Physical PAN Card from ePAN will be delivered?",
      answer: "Physical Card from ePAN will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying ePAN to Physical Card. Address proof having same address needs to be submitted along with application."
    },
    {
      question: "How can I track e PAN to Physical PAN Card Status after application?",
      answer: (
        <div>
          After applying Physical PAN Card from ePAN, you can track PAN card status on our portal at below link: <br />
  ...
  return (
    ...
    ePAN to Physical PAN Card Application <br/> <mark class="text-xtiny mt-1 d-inline-block" style={{fontSize:"20px"}}>With Sign On Card</mark> 
   ...
   <div className="form-correction-group">
    ...
    <div className="container">
      <h2 className="text-center">FAQs: e PAN to Physical PAN Card Application</h2>
      {faqs.map((faq, index) => (
...
export default EpanToPhysicalPanCArdForm;
