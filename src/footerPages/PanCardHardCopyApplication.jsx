...
const PanCardHardCopyApplication = () => {
  ...
  const faqs = [
    {
      question: "What is PAN Card HARD Copy?",
      answer: (
        <div>
          <p>PAN holder details is printed on Hard Card by Income Tax Department. It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. Most important, it has Hologram which makes it genuine ID proof for its holder. This is why PAN Card Hard is asked to by banks or other financial institutions as proof of Identity.</p>
        </div>
      )
    },
    {
      question: "Will I receive Original PAN Card Hard Copy?",
      answer: (
        <div>
          <p>Yes, we provide only Original PAN Card Hard Copy having Genuine Hologram directly from Department and delivered to applicant address as per address proof submitted.</p>
        </div>
      )
    },
    {
      question: "Whether PAN Card Hard Copy is required?",
      answer: (
        <div>
          <p>Some Banks or Financial Institutions ask to present PAN Card Hard Copy as PAN proof. Hence sometimes, at such moments PAN Card Hard Copy is required.</p>
        </div>
      )
    },
    {
      question: "How to apply for PAN Card Hard Copy online?",
      answer: (
        <div>
          <p>You can apply for PAN Card Hard Copy online by filling up the above PAN Card Hard Copy Application Form and complete all steps with required documents.</p>
        </div>
      )
    },
    {
      question: "How to get e PAN Card Hard Copy?",
      answer: (
        <div>
          <p>You can get e PAN Card Hard Copy by filling up the above PAN Hard Copy Application Form and complete all steps with required documents.</p>
        </div>
      )
    },
    {
      question: "How to get instant PAN Card Hard Copy?",
      answer: (
        <div>
          <p>You can get instant PAN Card Hard Copy by filling up the above PAN Hard Copy Application Form and complete all steps with required documents.</p>
        </div>
      )
    },
    {
      question: "What Documents are required for PAN Card Hard Copy Application?",
      answer: (
        <div>
          <div>
    ...
    {
      question: "Who has to sign the PAN Hard Copy application?",
      answer: (
        <div>
          <p>PAN Holder needs to sign the PAN Card Hard Copy Form. If he/she is unable to sign then left thumb impression is required on form.</p>
        </div>
      )
    },
    {
      question: "How PAN Card Hard Copy will be delivered?",
      answer: (
        <div>
          <p>PAN Hard Copy will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying PAN Hard Copy. Address proof having same address needs to be submitted along with application.</p>
        </div>
      )
    },
    {
      question: "How can I track PAN Card Hard Copy Status after application?",
      answer: (
        <div>
          <p>After applying for PAN Card Hard Copy, you can track PAN card status on our portal at below link:</p>
  ...
  return (
    ...
    PAN Card HARD Copy Application <br/> <mark class="text-xtiny mt-1 d-inline-block" style={{fontSize:"20px"}}>Get ORIGINAL Card with Hologram</mark> 
   ...
   <div className="form-correction-group">
    ...
    <div className="container">
      <h2 className="text-center">FAQs on PAN Card HARD Copy Apply Online</h2>
      {faqs.map((faq, index) => (
...
export default PanCardHardCopyApplication;
