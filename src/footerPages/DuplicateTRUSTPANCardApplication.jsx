...
const DuplicateTRUSTPANCardApplication = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Duplicate TRUST PAN Card Application</h1>
...
export default DuplicateTRUSTPANCardApplication;
