...
const ChangeDOBPanCard = () => {
  ...
  const faqs = [
    {
      question: "How to Change DOB in PAN Card online?",
      answer: (
        <div>
          You can apply for Changing DOB in PAN Card online by filling up the above Application Form and complete all steps with required documents.
        </div>
      )
    },
    {
      question: "Whether Change of DOB in PAN Card is required?",
      answer: (
        <div>
          Some Banks or Financial Institutions ask to present PAN Card with correct DOB in PAN proof. Hence sometimes, at such moments PAN Card with correct DOB is required.
        </div>
      )
    },
    {
      question: "What Documents are required for Changing DOB in PAN Card?",
      answer: (
        <div>
    ...
    {
      question: "Who has to sign PAN Card DOB Change Form?",
      answer: (
        <div>
          PAN Holder needs to sign the PAN Card DOB Change Form. If he/she is unable to do sign then left thumb impression is required on form.
        </div>
      )
    },
    {
      question: "How PAN Card with Changed DOB will be delivered?",
      answer: (
        <div>
          PAN Card with Changed DOB will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying Signature Change in PAN. Address proof having same address needs to be submitted along with application.
        </div>
      )
    },
    {
      ...
      answer: (
        <div>
          After applying for DOB Change in PAN Card, you can track PAN card status on our portal at below link: <br />
  ...
  return (
    ...
    <div className="container">
      <div className="">
        <h1 className="hero-body pan-form-heading">Change DOB in PAN Card Application</h1>
      </div>
    ...
    <div className="container">
      <h2 className="text-center">FAQs: Change DOB in PAN Card</h2>
      {faqs.map((faq, index) => (
...
export default ChangeDOBPanCard;
