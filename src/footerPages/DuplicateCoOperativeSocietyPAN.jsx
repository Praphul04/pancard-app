...
const DuplicateCoOperativeSocietyPAN = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Duplicate Co-Operative Society PAN Card Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in  <span className="sub-i-b">Co-Operative Society's Name</span>
          </label>
</div>
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated Co-Operative Society Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">Co-Operative Society Name Identity Proof</label>
            <select
      ...
      <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">Co-Operative Society DETAILS</label>
            <label className="form-label" htmlFor="pan-form-applicant-full-name">
            Co-Operative Society Full Name
            </label>
            <input
              className="form-input"
              type="text"
 ...
 {/* Co-Operative Society Name Identity Proof */}
 <div className="hero bg-gray make-correction-checkbox-hero">
        ...
        <select className="form-select" id="pan-form-select-poi-proof">
          ...
          <option value="registration-number-by-charity-commissioner">
            Registration Certificate issued by Charity Commissioner
          </option>
          <option value="registration-number-by-cooperative-society-registrar">
            Registration Certificate issued by Cooperative Society Registrar
          </option>
          <option value="registration-number-by-competent-authority">
            Registration Certificate issued by any other Competent Authority
          </option>
          <option value="any-document-by-central-state">
  ...
  {/* Date Of Incorporation/Formation Proof */}
  <div className="form-group general-info-group podob-proof hide delete">
        <label className="form-label" htmlFor="pan-form-select-podob-proof">
          Date Of Incorporation/Formation Proof
        </label>
        <select className="form-select" id="pan-form-select-podob-proof">
          <option value="">Select Date of Incorporation/Formation Proof</option>
          {/* Additional options can be added here */}
        </select>
      </div>

      {/* Co-Operative Society Address Proof */}
      <div className="hero bg-gray make-correction-checkbox-hero">
        <label className="form-label" htmlFor="pan-form-select-poa-proof">
          Co-Operative Society Address Proof <sup>*</sup>
        </label>
        <select className="form-select" id="pan-form-select-poa-proof">
          <option value="">Select Address Proof</option>
          <option value="agreement">Copy of Agreement</option>
          <option value="registration-number-by-charity-commissioner">
            Registration Certificate issued by Charity Commissioner
...
export default DuplicateCoOperativeSocietyPAN;
