...
const EPanToNormalPan = () => {
  ...
  const faqs = [
    {
      question: "What is ePAN to Normal PAN Card?",
      answer: (
        <div>
          <p>PAN holder details is printed on Normal Card by Income Tax Department. It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. It also has Hologram which makes it genuine ID proof for its holder. This is why Normal PAN Card from ePAN is asked to by banks or other financial institutions as proof of Identity.</p>
        </div>
      )
    },
    {
      question: "Why ePAN to Normal PAN Card is required?",
      answer: (
        <div>
          <p>Some Banks or Financial Institutions ask to present Normal PAN Card as PAN proof even though we have ePAN copy while opening bank account or any work related to loans. At such moments it is necessary to convert ePAN to Normal PAN Card.</p>
        </div>
      )
    },
    {
      question: "How to get Normal PAN Card from ePAN?",
      answer: (
        <div>
          <p>You can get Normal PAN Card from ePAN by filling up the above ePAN to Normal Card Application Form and complete all steps with required documents.</p>
        </div>
      )
    },
    {
      question: "How to convert ePAN to Normal PAN Card?",
      answer: (
        <div>
          <p>To convert ePAN to Normal PAN Card, you need to Apply for 'ePAN to Normal PAN Card' using above Application Form and get Normal Card delivered at home as per address mentioned in the form.</p>
        </div>
      )
    },
    {
      question: "What Documents are required to convert ePAN to Normal PAN Card?",
      answer: (
        <div>
          <p><strong>Date Of Birth Proof (Any one of the following):</strong></p>
          <ol>
          ...
          <p><strong>Identity Proof (Any one of the following):</strong></p>
          <ol>
            <li>Central Government Health Scheme Card.</li>
          ...
          <p><strong>Address Proof (Any one of the following):</strong></p>
          <ol>
            <li>Domicile certificate issued by the Government.</li>
    ...
    {
      question: "How Normal PAN Card from ePAN will be delivered?",
      answer: (
        <div>
          <p>Normal Card from ePAN will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying ePAN to Normal Card. Address proof having same address needs to be submitted along with application.</p>
        </div>
      )
    },
    {
      question: "How can I track ePAN to Normal PAN Card Status after application?",
      answer: (
        <div>
          <p>After applying Normal PAN Card from ePAN, you can track PAN card status on our portal at below link: <br /> <a href="https://www.pancardapp.com/track-pan-card.php">Track PAN Card Status</a></p>
        </div>
      )
    }
  ];
  ...
  return (
    ...
    <div className="container">
      <div className="">
        <h1 className="hero-body pan-form-heading"> ePAN to Normal PAN Card Application</h1>
      </div>
   ...
   <div className="form-correction-group">
    ...
    <div className="container">
      <h2 className="text-center">FAQs: e PAN to Normal PAN Card Process</h2>
      {faqs.map((faq, index) => (
...
export default EPanToNormalPan;
