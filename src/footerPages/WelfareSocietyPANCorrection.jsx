...
const WelfareSocietyPANCorrection = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Welfare Society PAN Card Correction Application</h1>
...
export default WelfareSocietyPANCorrection;
