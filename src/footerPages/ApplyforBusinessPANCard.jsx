...
const ApplyforBusinessPANCard = () => {
  ...
  const faqs = [
    {
      question: "How to apply PAN card for Business?",
      answer: "You can apply PAN Card for Business online by filling up the above Business PAN Card Application Form and completing all steps with the required documents."
    },
    {
      question: "What Documents are required for Business PAN Card Application?",
      answer: (
        <div>
          For Business PAN Card, the following documents are required:
          <div className="text-bold">
            Business Identity Proof (Any one):
          </div>
          <ol>
    ...
    {
      question: "Who has to sign the PAN application for Business?",
      answer: "Any one Partner of Business can sign the PAN Card Form."
    },
    {
      question: "How Business PAN Card will be delivered?",
      answer: "Business PAN Card will be delivered to the Business's Address by Courier mentioned in PAN Form while applying for Business PAN Card online. Address proof having the same address needs to be submitted along with the application."
    },
    {
      question: "How can I track Business PAN Card Status after application?",
      answer: (
        <div>
          After applying for a Business PAN Card, you can track the PAN Card status on our portal at the below link:
          <br />
          ...
          >
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                <div className="form-group">
                  <label className="form-label" htmlFor="pan-form-applicant-full-name">Business Name</label>
                  <input
                ...
                <div className="form-group form-group-select-poi-proof">
                  <label className="form-label" htmlFor="pan-form-select-poi-proof">Business Identity Proof</label>
                  <select
                    className="form-select"
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="pan-form-select-poa-proof">Business Address Proof * <sup>*</sup></label>
                  <select
                    className="form-select"
...
<h2 className="text-center">FAQs: Apply for Business PAN Card</h2>
{faqs.map((faq, index) => (
...
export default ApplyforBusinessPANCard;
