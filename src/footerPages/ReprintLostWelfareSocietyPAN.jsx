...
const ReprintLostWelfareSocietyPAN = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint Lost Welfare Society PAN Card</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in  <span className="sub-i-b">Welfare Society's Name</span>
          </label>
</div>
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated Welfare Society Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">Welfare Society Name Identity Proof</label>
            <select
      ...
      <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">Welfare Society DETAILS</label>
            <label className="form-label" htmlFor="pan-form-applicant-full-name">
            Welfare Society Full Name
            </label>
            <input
              className="form-input"
              type="text"
 ...
 <div className="hero bg-gray make-correction-checkbox-hero">
        ...
        Welfare Society Name Identity Proof
        </label>
  ...
  <div className="form-group general-info-group podob-proof hide delete">
      ...
      <div className="hero bg-gray make-correction-checkbox-hero">
        <label className="form-label" htmlFor="pan-form-select-poa-proof">
        Welfare Society Address Proof * <sup>*</sup>
        </label>
...
export default ReprintLostWelfareSocietyPAN;
