...
const PANApplicationJointVenture = () => {
  ...
  const faqs = [
    ...
    {
      question: "How to apply PAN card for Joint Venture?",
      answer: (
        <p className="faq-answer-text">
          You can apply PAN Card for Joint Venture online by filling up the above Joint Venture PAN Card Application Form and complete all steps with required documents.
        </p>
      )
    },
    {
      question: "What Documents are required for Joint Venture PAN Card Application?",
      answer: (
        <div>
          For Joint Venture PAN Card following documents are required:
          <div className="text-bold">
            Joint Venture Identity Proof (Any one):
          </div>
          <ol>
          ...
          <div className="text-bold">
            Joint Venture Address Proof (Any one):
          </div>
          <ol>
            <li>Copy of Agreement</li>
            <li>Registration Certificate issued by Charity Commissioner</li>
    ...
    {
      question: "Who has to sign the PAN application for Joint Venture?",
      answer: (
        <p className="faq-answer-text">
          Any one Authorized Signatory or Managing Person like Director or Partner can sign the PAN Card Form.
        </p>
      )
    },
    {
      question: "How Joint Venture PAN Card will be delivered?",
      answer: (
        <p className="faq-answer-text">
          Joint Venture PAN Card will be delivered to Joint Venture's Address by Courier mentioned in PAN Form while applying pan card for Joint Venture online. Address proof having same address needs to be submitted along with application.
        </p>
      )
    },
    {
      question: "How can I track Joint Venture PAN Card Status after application?",
      answer: (
        <p className="faq-answer-text">
          After applying PAN Card for Joint Venture, you can track PAN card status on our portal at below link:
          <br />
      ...
      <div className="columns">
        <div className="column col-12">
          <h1 className="pan-form-heading">New PAN Application for
            <small className="label">Joint Venture</small>
          </h1>
        </div>
        <div className="column col-12">
          <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                <div className="form-group">
                  <label className="form-label" htmlFor="fullName">Joint Venture Full Name</label>
                  <input
                ...
                <div className="form-group form-group-select-poi-proof">
                  <label className="form-label" htmlFor="identityProof">Joint Venture Identity Proof</label>
                  <select
                    className="form-select"
                    id="identityProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select Joint Venture Identity Proof</option>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                ...
                <div className="form-group form-group-address-proof">
                  <label className="form-label" htmlFor="addressProof">Joint Venture Address Proof</label>
                  <select
                    className="form-select"
                    id="addressProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select Joint Venture Address Proof</option>
...
<h2 className="text-center">FAQs: Apply PAN Card for Joint Venture</h2>
{faqs.map((faq, index) => (
...
export default PANApplicationJointVenture;
