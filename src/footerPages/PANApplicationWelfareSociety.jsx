...
const PANApplicationWelfareSociety = () => {
...
<div className="columns">
  <div className="column col-12">
    <h1 className="pan-form-heading">New PAN Application for
      <small className="label">Welfare Society</small>
    </h1>
  </div>
  <div className="column col-12">
    <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        >
          ...
          <option value="llp" data-url="/apply-online-new-pan-card-application-form/limited-liability-partnership-LLP">Limited Liability Partnership (LLP)</option>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          <div className="form-group">
            <label className="form-label" htmlFor="fullName">Welfare Society Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof">
            <label className="form-label" htmlFor="identityProof">Welfare Society Identity Proof</label>
            <select
              className="form-select"
              id="identityProof"
              ...
              onChange={handleChange}
            >
              <option value>Select Welfare Society Identity Proof</option>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          ...
          <div className="form-group form-group-address-proof">
            <label className="form-label" htmlFor="addressProof">Welfare Society Address Proof *</label>
            <select
              className="form-select"
              id="addressProof"
...
export default PANApplicationWelfareSociety;
