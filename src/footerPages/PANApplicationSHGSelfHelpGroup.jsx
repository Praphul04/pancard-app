...
const PANApplicationSHGSelfHelpGroup = () => {
  ...
  const faqs = [
    {
      question: "What is SHG Self Help Group PAN Card?",
      answer: (
        <p className="faq-answer-text">
          PAN Card for SHG Self Help Groups is called SHG PAN Card.
          It has the PAN number printed on top and contains the SHG Self Help Group's name, date of formation on it. Most importantly, it also has a Hologram which makes it a genuine Identity/Entity proof for SHG Self Help Group. This is why SHG PAN Card is asked for by banks or other financial institutions as proof of Identity/Entity.
        </p>
      )
    },
    {
      question: "How to apply PAN Card for SHG group?",
      answer: (
        <p className="faq-answer-text">
          You can apply for a PAN Card for Self Help Group online by filling up the above SHG PAN Card Application Form and completing all steps with the required documents.
        </p>
      )
    },
    {
      question: "What Documents are required for SHG Self Help Group PAN Card Application?",
      answer: (
        <div>
          For SHG Self Help Group PAN Card, the following documents are required:
          <div className="text-bold">
            SHG - Self Help Group Identity Proof (Any one):
          </div>
          <ol>
          ...
          <div className="text-bold">
            SHG - Self Help Group Address Proof (Any one):
          </div>
          <ol>
            <li>Registration Certificate issued by Charity Commissioner.</li>
            <li>Registration Certificate issued by Cooperative Society Registrar.</li>
    ...
    {
      question: "Who has to sign the PAN application for SHG - Self Help Group?",
      answer: (
        <p className="faq-answer-text">
          Any one Authorized Signatory or Managing Person needs to sign the PAN Card Form. If he/she is unable to sign, then a left thumb impression is required on the form.
        </p>
      )
    },
    {
      question: "How SHG - Self Help Group PAN Card will be delivered?",
      answer: (
        <p className="faq-answer-text">
          SHG - Self Help Group PAN Card will be delivered to the SHG - Self Help Group's Address by Courier, as mentioned in the PAN Form while applying for the PAN Card for SHG online. Address proof with the same address needs to be submitted along with the application.
        </p>
      )
    },
    {
      question: "How can I track SHG - Self Help Group PAN Card Status after application?",
      answer: (
        <p className="faq-answer-text">
          After applying for a PAN Card for SHG - Self Help Group, you can track the PAN Card status on our portal at the below link:
          <br />
      ...
      <div className="columns">
        <div className="column col-12">
          <h1 className="pan-form-heading">New PAN Application for
            <small className="label">SHG - Self Help Group</small>
          </h1>
        </div>
        <div className="column col-12">
          <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                <div className="form-group">
                  <label className="form-label" htmlFor="fullName">SHG - Self Help Group Full Name</label>
                  <input
                ...
                <div className="form-group form-group-select-poi-proof">
                  <label className="form-label" htmlFor="identityProof">SHG - Self Help Group Identity Proof</label>
                  <select
                    className="form-select"
                    id="identityProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select SHG - Self Help Group Identity Proof</option>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                ...
                <div className="form-group form-group-address-proof">
                  <label className="form-label" htmlFor="addressProof">SHG - Self Help Group Address Proof</label>
                  <select
                    className="form-select"
                    id="addressProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select SHG - Self Help Group Address Proof</option>
                ...
                <div className="form-group form-group-authorized-signatory">
                  <label className="form-label" htmlFor="authorizedSignatory">Authorized Signatory</label>
                  <input
                    className="form-input"
                    type="text"
                    id="authorizedSignatory"
                    placeholder="Enter Authorized Signatory here"
...
<h2 className="text-center">FAQs: Apply PAN Card for SHG - Self Help Group</h2>
{faqs.map((faq, index) => (
...
export default PANApplicationSHGSelfHelpGroup;
