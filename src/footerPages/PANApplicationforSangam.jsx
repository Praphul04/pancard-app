...
<div className="columns">
  <div className="column col-12">
    <h1 className="pan-form-heading">New PAN Application for
      <small className="label">Sangam</small>
    </h1>
  </div>
  <div className="column col-12">
    <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          <div className="form-group">
            <label className="form-label" htmlFor="fullName">Sangam Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof">
            <label className="form-label" htmlFor="identityProof">Sangam Identity Proof</label>
            <select
              className="form-select"
              id="identityProof"
              ...
              onChange={handleChange}
            >
              <option value>Select Sangam Identity Proof</option>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          ...
          <div className="form-group form-group-address-proof">
            <label className="form-label" htmlFor="addressProof">Sangam Address Proof *</label>
            <select
              className="form-select"
              id="addressProof"
              ...
              onChange={handleChange}
            >
              <option value>Select Sangam Address Proof</option>
...
export default PANApplicationforSangam;
