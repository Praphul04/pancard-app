...
const ReprintLLPPANCardApplication = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint LLP PAN Card Application</h1>
...
export default ReprintLLPPANCardApplication;
