...
const ReprintDamagedPartnershipFirmPAN = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint Damaged Partnership Firm PAN Card</h1>
...
export default ReprintDamagedPartnershipFirmPAN;
