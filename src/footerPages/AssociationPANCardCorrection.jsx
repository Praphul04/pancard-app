...
const AssociationPANCardCorrection = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Association PAN Card Correction Application</h1>
...
<div className="hero bg-gray make-correction-checkbox-hero">
      ...
      <div className="hero bg-gray make-correction-checkbox-hero">
              <label className="form-label" htmlFor="pan-form-select-poa-proof">
              Association Address Proof * <sup>*</sup>
              </label>
              <select
                className="form-select"
                id="pan-form-select-poa-proof"
...
export default AssociationPANCardCorrection;
