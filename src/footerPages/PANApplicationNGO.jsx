...
const PANApplicationNGO = () => {
  ...
  const faqs = [
    ...
    {
      question: "How to apply PAN card for NGO?",
      answer: (
        <p className="faq-answer-text">
          You can apply PAN Card for NGO online by filling up the above NGO PAN Card Application Form and complete all steps with required documents.
        </p>
      )
    },
    {
      question: "What Documents are required for NGO PAN Card Application?",
      answer: (
        <div>
          For NGO PAN Card following documents are required:
          <div className="text-bold">
            NGO Identity Proof (Any one):
          </div>
          <ol>
    ...
    {
      question: "Who has to sign the PAN application for NGO?",
      answer: (
        <p className="faq-answer-text">
          Any one Authorized Signatory or Managing Person like Chairman, Secretary or Trustee can sign the PAN Card Form.
        </p>
      )
    },
    {
      question: "How NGO PAN Card will be delivered?",
      answer: (
        <p className="faq-answer-text">
          NGO PAN Card will be delivered to NGO's Address by Courier mentioned in PAN Form while applying pan card for NGO online. Address proof having same address needs to be submitted along with application.
        </p>
      )
    },
    {
      question: "How can I track NGO PAN Card Status after application?",
      answer: (
        <p className="faq-answer-text">
          After applying PAN Card for NGO, you can track PAN card status on our portal at below link:
          <br />
      ...
      <div className="columns">
        <div className="column col-12">
          <h1 className="pan-form-heading">New PAN Application for
            <small className="label">NGO</small>
          </h1>
        </div>
        <div className="column col-12">
          <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                <div className="form-group">
                  <label className="form-label" htmlFor="fullName">NGO Full Name</label>
                  <input
                ...
                <div className="form-group form-group-select-poi-proof">
                  <label className="form-label" htmlFor="identityProof">NGO Identity Proof</label>
                  <select
                    className="form-select"
                    id="identityProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select NGO Identity Proof</option>
            ...
            <div className="hero bg-gray">
              <div className="hero-body">
                ...
                <div className="form-group form-group-address-proof">
                  <label className="form-label" htmlFor="addressProof">NGO Address Proof</label>
                  <select
                    className="form-select"
                    id="addressProof"
                    ...
                    onChange={handleChange}
                  >
                    <option value>Select NGO Address Proof</option>
...
export default PANApplicationNGO;
