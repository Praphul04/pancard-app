...
const PartnershipFirmPanCorrection = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Partnership Firm PAN Card Correction Application</h1>
...
export default PartnershipFirmPanCorrection;
