...
const PANApplicationforEducationalSociety = () => {
...
<div className="columns">
  <div className="column col-12">
    <h1 className="pan-form-heading">New PAN Application for
      <small className="label">Educational Society</small>
    </h1>
  </div>
  <div className="column col-12">
    <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          <div className="form-group">
            <label className="form-label" htmlFor="fullName">Educational Society Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof">
            <label className="form-label" htmlFor="identityProof">Educational Society Identity Proof</label>
            <select
              className="form-select"
              id="identityProof"
              ...
              onChange={handleChange}
            >
              <option value>Select Educational Society Identity Proof</option>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          ...
          <div className="form-group form-group-address-proof">
            <label className="form-label" htmlFor="addressProof">Educational Society Address Proof *</label>
            <select
              className="form-select"
              id="addressProof"
              ...
              onChange={handleChange}
            >
              <option value>Select Educational Society Address Proof</option>
...
export default PANApplicationforEducationalSociety;
