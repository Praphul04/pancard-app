...
const DuplicateLLPPANCardApplication = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Duplicate LLP PAN Card Application</h1>
...
export default DuplicateLLPPANCardApplication;
