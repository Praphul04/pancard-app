...
const HousingSocietyPANCardCorrection = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Housing Society PAN Card Correction Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in   <span className="sub-i-b">Housing Society's Name</span>
          </label>
</div>
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated Housing Society Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">Housing Society Name Identity Proof</label>
            <select
       ...
       <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">Housing Society DETAILS</label>
            <label className="form-label" htmlFor="pan-form-applicant-full-name">
            Housing Society Full Name
            </label>
            <input
              className="form-input"
              type="text"
...
<div className="hero bg-gray make-correction-checkbox-hero">
        ...
        Housing Society Name Identity Proof
        </label>
      ...
      <div className="hero bg-gray make-correction-checkbox-hero">
              <label className="form-label" htmlFor="pan-form-select-poa-proof">
              Housing Society Address Proof * <sup>*</sup>
              </label>
              <select
                className="form-select"
                id="pan-form-select-poa-proof"
...
export default HousingSocietyPANCardCorrection;
