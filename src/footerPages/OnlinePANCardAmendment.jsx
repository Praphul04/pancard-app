...
const OnlinePANCardAmendment = () => {
  ...
  const faqs = [
    {
      question: "How to do online PAN Card amendment?",
      answer: (
        <div>
          You can apply for PAN Card amendment online by filling up the above Application Form and complete all steps with required documents.
        </div>
      )
    },
    {
      question: "Whether PAN Card amendment is required?",
      answer: (
        <div>
          Some Banks or Financial Institutions ask to present PAN Card with correct DOB in PAN proof. Hence sometimes, at such moments PAN Card amendment with latest data is required.
        </div>
      )
    },
    {
      question: "What Documents are required for PAN Card Amendment?",
      answer: (
        <div>
    ...
    {
      question: "Who has to sign PAN Card Amendment Form?",
      answer: (
        <div>
          PAN Holder needs to sign the PAN Card Amendment Form. If he/she is unable to sign, then a left thumb impression is required on the form.
        </div>
      )
    },
    {
      question: "How PAN Card with Amendment will be delivered?",
      answer: (
        <div>
          PAN Card with Amendment will be delivered to the PAN Holder's Home Address by Courier mentioned in the PAN Form while applying for the amendment. Address proof having the same address needs to be submitted along with the application.
        </div>
      )
    },
    {
      question: "How can I track my PAN Card Status after Amendment application?",
      answer: (
        <div>
          After applying for Amendment in PAN Card, you can track PAN card status on our portal at the following link: <br />
  ...
  return (
    ...
    <div className="container">
      <div className="">
        <h1 className="hero-body pan-form-heading">Online PAN Card Amendment Form</h1>
      </div>
    ...
    <div className="container">
      <h2 className="text-center">FAQs: PAN Card Amendment</h2>
      {faqs.map((faq, index) => (
...
export default OnlinePANCardAmendment;
