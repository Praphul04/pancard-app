...
const PlasticPanCardApplication = () => {
  ...
  const faqs = [
    {
      question: "What is Plastic PAN Card?",
      answer: (
        <div>
          <p>PAN holder details is printed on Plastic Card by Income Tax Department. It has PAN number printed on top and contains PAN holder's name, date of birth, father's name. Most important, it has Hologram which makes it genuine ID proof for its holder. This is why Plastic PAN Card is asked to by banks or other financial institutions as proof of Identity.</p>
        </div>
      )
    },
    {
      question: "Will I receive Original Plastic PAN Card?",
      answer: (
        <div>
          <p>Yes, we provide only Original Plastic PAN Card having Genuine Hologram directly from Department and delivered to applicant address as per address proof submitted.</p>
        </div>
      )
    },
    {
      question: "Whether Plastic PAN Card is required?",
      answer: (
        <div>
          <p>Some Banks or Financial Institutions ask to present Plastic PAN Card as PAN proof. Hence sometimes, at such moments Plastic PAN Card is required.</p>
        </div>
      )
    },
    {
      question: "How to apply for Plastic PAN Card online?",
      answer: (
        <div>
          <p>You can apply for Plastic PAN Card online by filling up the above Plastic Card Application Form and complete all steps with required documents.</p>
        </div>
      )
    },
    {
      question: "What Documents are required for Plastic PAN Card Application?",
      answer: (
        <div>
          <div>
    ...
    {
      question: "Who has to sign the Plastic PAN application?",
      answer: (
        <div>
          <p>PAN Holder needs to sign the PAN Card Form. If he/she is unable to do sign then left thumb impression is required on form.</p>
        </div>
      )
    },
    {
      question: "How Plastic PAN Card will be delivered?",
      answer: (
        <div>
          <p>Plastic Card will be delivered to PAN Holder's Home Address by Courier mentioned in PAN Form while applying Plastic Card. Address proof having same address needs to be submitted along with application.</p>
        </div>
      )
    },
    {
      question: "How can I track Plastic PAN Card Status after application?",
      answer: (
        <div>
          <p>After applying for Plastic PAN Card, you can track PAN card status on our portal at below link:</p>
  ...
  return (
    ...
    Plastic PAN Card Application <br/> <mark class="text-xtiny mt-1 d-inline-block" style={{fontSize:"20px"}}>Get ORIGINAL Card with Hologram</mark> 
   ...
   <div className="form-correction-group">
    ...
    <div className="container">
      <h2 className="text-center">FAQs on Plastic PAN Card Apply Online</h2>
      {faqs.map((faq, index) => (
...
export default PlasticPanCardApplication;
