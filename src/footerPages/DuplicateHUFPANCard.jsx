...
const DuplicateHUFPANCard = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Duplicate HUF PAN Card Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in  <span className="sub-i-b">HUF's Name</span>
          </label>
</div>
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated HUF Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">HUF Name Identity Proof</label>
            <select
      ...
      <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">HUF DETAILS</label>
...
export default DuplicateHUFPANCard;
