...
const CoOperativePANCardCorrectionApplication = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Co-Operative Society PAN Card Correction Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in Co-Operative Society's <span className="sub-i-b">Name</span>
          </label>
</div>
{nameCorrection && (
...
export default CoOperativePANCardCorrectionApplication;
