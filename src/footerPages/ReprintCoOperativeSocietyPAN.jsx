...
const ReprintCoOperativeSocietyPAN = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint Co-Operative Society PAN Card Application</h1>
...
export default ReprintCoOperativeSocietyPAN;
