...
const ReprintTRUSTPANCardApplication = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint TRUST PAN Card Application</h1>
            ...
            <div className="form-group mt-2">
              <div className="columns">
                <div className="column col-4 col-md-4 col-sm-12 col-xs-12">
                  <label className="form-label" htmlFor="application_name_birfurcation_last_name">
                    Surname / Last Name
                  </label>
                  <input
                    className="form-input"
                    ...
                    value={trustDetails.surname}
                    onChange={(e) => setTrustDetails({ ...trustDetails, surname: e.target.value })}
                  />
                </div>
                <div className="column col-4 col-md-4 col-sm-12 col-xs-12">
                  <label className="form-label" htmlFor="application_name_birfurcation_first_name">
                    First Name
                  </label>
                  <input
                    className="form-input"
                    ...
                    onChange={(e) => setTrustDetails({ ...trustDetails, firstName: e.target.value })}
                  />
                </div>
                <div className="column col-4 col-md-4 col-sm-12 col-xs-12">
                  <label className="form-label" htmlFor="application_name_birfurcation_middle_name">
                    Middle Name
                  </label>
                  <input
                    className="form-input"
                    ...
                    value={trustDetails.middleName}
                    onChange={(e) => setTrustDetails({ ...trustDetails, middleName: e.target.value })}
                  />
                </div>
              </div>
            </div>
...
export default ReprintTRUSTPANCardApplication;
