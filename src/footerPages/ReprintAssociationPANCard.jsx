...
const ReprintAssociationPANCard = () => {
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Reprint Association PAN Card Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in  <span className="sub-i-b">Association's Name</span>
          </label>
</div>
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated Association Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">Association Name Identity Proof</label>
            <select
      ...
      <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">Association DETAILS</label>
 ...
 <div className="hero bg-gray make-correction-checkbox-hero">
        ...
        Association Name Identity Proof
        </label>
...
export default ReprintAssociationPANCard;
