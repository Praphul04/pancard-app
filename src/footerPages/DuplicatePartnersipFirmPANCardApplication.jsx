...
const DuplicatePartnersipFirmPANCardApplication = () => {
  ...
  const [reprintChoice, setReprintChoice] = useState('no');
  ...
  return (
    <div className="container">
      <h1 className="hero-body pan-form-heading">Duplicate Partnership Firm PAN Card Application</h1>
      <form className="hero bg-gray" onSubmit={handleSubmit}>
        ...
        <div className="form-correction-group">
          ...
          <label className="form-checkbox">
            ...
            <i className="form-icon"></i>Make Correction in PARTNERSHIP-FIRM's <span className="sub-i-b">Name</span>
          </label>
...
{nameCorrection && (
        <div className="form-group name-change-group">
          ...
          <div className="form-group name-change-group full-name">
            <label className="form-label" htmlFor="pan-form-applicant-full-name">Updated PARTNERSHIP-FIRM Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof name-change-group">
            <label className="form-label" htmlFor="pan-form-select-poi-proof">PARTNERSHIP-FIRM Name Identity Proof</label>
            <select
      ...
      <div className="hero bg-gray general-info-hero-1">
        <div className="hero-body">
          <div className="form-group general-info-group full-name">
            <label className="form-label text-dark">PARTNERSHIP-FIRM DETAILS</label>
            <label className="form-label" htmlFor="pan-form-applicant-full-name">
            PARTNERSHIP-FIRM Full Name
            </label>
            <input
              className="form-input"
              type="text"
      ...
      <div className="hero bg-gray general-info-hero-2">
        <div className="hero-body">
          <div className="form-group form-group-select-poi-proof general-info-group poi-proof">
            ...
            PARTNERSHIP-FIRM Name Identity Proof
            </label>
            <select
              className="form-select"
              id="pan-form-select-poi-proof"
          ...
          <div className="form-group general-info-group poa-proof">
            <label className="form-label" htmlFor="pan-form-select-poa-proof">
            PARTNERSHIP-FIRM Address Proof * <sup>*</sup>
            </label>
            <select
              className="form-select"
              id="pan-form-select-poa-proof"
...
export default DuplicatePartnersipFirmPANCardApplication;
