...
const PANApplicationForSanstha = () => {
...
<div className="columns">
  <div className="column col-12">
    <h1 className="pan-form-heading">New PAN Application for
      <small className="label">Sanstha</small>
    </h1>
  </div>
  <div className="column col-12">
    <form className="main-pan-form aop" id="new-pan-form" method="POST" action="./" onSubmit={handleSubmit}>
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          <div className="form-group">
            <label className="form-label" htmlFor="fullName">Sanstha Full Name</label>
            <input
          ...
          <div className="form-group form-group-select-poi-proof">
            <label className="form-label" htmlFor="identityProof">Sanstha Identity Proof</label>
            <select
              className="form-select"
              id="identityProof"
      ...
      <div className="hero bg-gray">
        <div className="hero-body">
          ...
          <div className="form-group form-group-address-proof">
            <label className="form-label" htmlFor="addressProof">Sanstha Address Proof *</label>
            <select
              className="form-select"
              id="addressProof"
...
export default PANApplicationForSanstha;
